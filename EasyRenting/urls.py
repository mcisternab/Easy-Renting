...
urlpatterns = [
    ...
    path('dptos', login_required(views.dptos), name='dptos'),
    path('arrendar/<str:pk>/', login_required(views.arrendar), name='arrendar'),
    path('pasajero', login_required(views.pasajero.as_view())),
    ...
    path('contratoServicio/<str:pk>/', login_required(views.contratoServicio), name='contratoServicio'),
    path('contratoTransporte/<str:pk>/', login_required(views.contratoTransporte), name='contratoTransporte'),
    path('datosArriendo', login_required(views.datosArriendo)),
